 ...
 */
public class ImagePageThree extends javax.swing.JFrame {

    /**
     * Creates new form ImagePageThree
     */
    public ImagePageThree() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(homeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 410, 67, 65));
        ...
        imageThree.setIcon(new javax.swing.ImageIcon(getClass().getResource("/wimbledonapp/Image1.jpg"))); // NOI18N
        jPanel1.add(imageThree, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 370, 340));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImagePageThree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImagePageThree().setVisible(true);
            }
        });
    }
