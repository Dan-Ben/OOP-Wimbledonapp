 ...
 */
public class ImagePageOne extends javax.swing.JFrame {

    /**
     * Creates new form ImagePageOne
     */
    public ImagePageOne() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        imageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/wimbledonapp/Image3.jpg"))); // NOI18N
        imageOne.setText("jLabel1");
        jPanel1.add(imageOne, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 370, 340));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImagePageOne.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImagePageOne().setVisible(true);
            }
        });
    }
